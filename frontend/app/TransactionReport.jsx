...
const Budget = () => {
  ...
  const renderBudgetItem = ({ item, index }) => (
    <View style={styles.card}>
      ...
      <Text style={styles.itemText}>💲 Transaction Type: {item.TransactionType}
      
      </Text>
      <Text style={styles.itemText}>💲 Amount: {item.Amount}
       
      </Text>
      <Text style={styles.itemText}>💲 Description: {item.description}
       
      </Text>
      <Text style={styles.itemText}>💲 Date: {item.date}
